...
del(colon_ds)
print(f'Length of test dataset of colon organoids:', len(test_colon_ds))
...
# Create dataloader for the colon test dataset
sam_test_dataloader = DataLoader(sam_test_colon_ds, batch_size=1, shuffle=False)
device = "cuda"
...
# Create dataloader for the colon dataset
sam_test_dataloader = DataLoader(sam_test_colon_ds, batch_size=1, shuffle=False)
device = "cuda"
