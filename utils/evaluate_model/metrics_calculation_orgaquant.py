...
# Create dataloader for the intestinal test dataset
sam_test_dataloader = DataLoader(sam_test_int_ds, batch_size=1, shuffle=False)
device = "cuda"
...
# Create dataloader for the intestinal dataset
sam_test_dataloader = DataLoader(sam_test_int_ds, batch_size=1, shuffle=False)
device = "cuda"
